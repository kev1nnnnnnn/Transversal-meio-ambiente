...
import HeroImg1 from "../../assets/images/Innovation.png"
import HeroImg2 from "../../assets/images/bro.png"
import HeroImg3 from "../../assets/images/world.png"
...
const HeroSection = () => {
    ...
    return (
        <section className="w-full h-auto bg-gradient-to-r from-green-700 to-green-400 relative overflow-x-hidden">
                    ...
                    HeroTexts.map((hero, index) => (
                        <main className="w-full lg:h-screen md:h-[50vh] h-screen relative bg-zinc-900 overflow-x-hidden" key={index}>
                            <Zoom className="h-full">
                                <Image className="md:w-[45%] w-full md:h-full h-1/2" alt="HeroImg1" objectCover="object-cover" image={renderProfileImg(index)} />
                            </Zoom>
                            ...
                            <div className="md:w-[50%] w-full md:h-full h-1/2 absolute md:top-0 top-1/2 right-0 bg-zinc-900 flex flex-col md:justify-center justify-start lg:gap-8 md:gap-4 gap-2 lg:px-20 md:px-6 px-4 overflow-x-hidden">
                                ...
                                <div className="flex items-center gap-8">
                                    <Slide direction="up">
                                    <Button type="button" className="px-10 font-medium text-white py-2.5 bg-gradient-to-r whitespace-nowrap from-green-700 to-green-400">
                                        {hero.Button}
                                    </Button>
                                    ...
                                    <Slide direction="up">
                                        <a href="/" className="flex items-center gap-2 text-green-500 hover:text-green-500 group">
            ...
            <div className="flex justify-end lg:justify-start items-center gap-4 absolute lg:bottom-10 md:bottom-5 md:right-10 right-4 bottom-4">
                <Button onClick={previous} type="button" className="w-8 h-8 border rounded-full border-green-700 flex items-center justify-center text-green-700 hover:text-green-500 hover:border-green-500">
                    <ArrowCircleLeft size={20} color="currentColor" weight="light" />
                </Button>
                <Button onClick={next} type="button" className="w-8 h-8 border rounded-full border-green-700 flex items-center justify-center text-green-700 hover:text-green-500 hover:border-green-500">

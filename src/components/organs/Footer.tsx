...
import { MoonStars, MapPin, Info } from "@phosphor-icons/react"
...
const Footer = () => {
    ...
    const renderIcon = useCallback((element: number) => {
        switch (element) {
            ...
            case 2:
                return <MoonStars size={20} color="currentColor" />
        }
    }, [])
    ...
    return (
        <footer className="w-full bg-zinc-950 flex flex-col">
            <main className="w-full lg:pt-28 lg:pb-12 pt-20 pb-12 px-6 grid md:grid-cols-3 lg:gap-8 md:gap-5 gap-8 lg:px-32">
                <div className="flex flex-col gap-2">
                    <Link to={`/`} className="font-extrabold flex items-center relative md:text-3xl text-2xl">
                        ...
                        <Text as="span" className="bg-gradient-to-r from-green-500 to-green-700 bg-clip-text text-transparent">ES</Text>
                    </Link>
            ...
            <div className="text-center py-3 bg-gradient-to-r from-green-500 to-green-700">

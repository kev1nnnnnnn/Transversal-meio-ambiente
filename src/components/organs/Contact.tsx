...
import ContactImg from "../../assets/contact/maps.png"
    ...
    return (
        <section className="w-full md:h-[400px] h-[500px] relative">
            ...
            <div className="w-full h-full absolute top-0 left-0 bg-zinc-900/70 flex flex-col justify-center items-center gap-2">
                ...
                <Button className="px-10 font-medium text-white py-2.5 bg-gradient-to-r whitespace-nowrap from-green-700 to-green-500" type="button">
                    {ContactTexts.button}
                </Button>
            </div>
        </section>

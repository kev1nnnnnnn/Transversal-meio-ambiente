...
import Image1 from "../../assets/about/principal.jpeg";
import Image2 from "../../assets/about/01.jpg";
import Image3 from "../../assets/about/02.jpg";
import Image4 from "../../assets/about/03.jpg";
    ...
    return (
        <section className="w-full h-auto flex items-center bg-zinc-950">
            <main className="w-full md:h-[700px] grid md:grid-cols-2 items-center lg:mx-20 md:mx-10 mx-6 gap-10 md:gap-10 py-12 md:py-0">
                ...
                <Fade>
                    <div className="flex flex-col mt-10 items-start relative before:absolute before:-bottom-6 before:left-0 before:w-20 before:h-1 before:rounded-lg before:bg-gradient-to-r before:from-green-300 before:to-green-700 z-10">
